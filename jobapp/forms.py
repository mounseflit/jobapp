...
class JobEditForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            "company_name",
            "company_description",
            "url",'question_1', 'answer_1', 'question_2', 'answer_2', 'question_3', 'answer_3'
            ]
...
class JobQuizForm(forms.Form):
    answer_1 = forms.CharField(max_length=200, label='Answer 1')
    answer_2 = forms.CharField(max_length=200, label='Answer 2')
    answer_3 = forms.CharField(max_length=200, label='Answer 3')